                        ...
                        <div class="col-sm-8 offset-2">
                            <form action="{{url(route('client-new-order',$productinfo->id))}}" method="post" enctype="multipart/form-data">
                                ...
                                <div id="" class="row  cartitem">
                                    ...
                                    <div class="col-sm-8 ">
                                        <input name="product_id" type="hidden"  value="{{$productinfo->id}}"></input>
                                        ...
                                        <input name="notes" style="width:400px;" type="text" placeholder="ملاحظات" class="form-control"></input>
                                        <br>
                                        <input name="address" style="width:400px;" type="text" placeholder="العنوان" class="form-control"></input>
                                        <br>
                                        <input name="quantity" style="width:400px;" type="number" placeholder="الكميه" class="form-control"></input>
                                        <br>
                                ...
                                <form action="{{url(route('client-new-order-cart'))}}" method="post" enctype="multipart/form-data">
                                    ...
                                    @foreach($productcart as $productshow) 
                                        ...
                                        <div id="" class="row  cartitem">
                                            ...
                                            <div class="col-sm-8 ">
                                                <input name="product[]" type="hidden"  value="{{$productshow->product()->first()->id}}"></input>
